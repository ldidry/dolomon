        ...
        case 'dolo':
            ...
            modal.find('.modal-body form').html(
                [
                    ...
                    '    <label for="url">',
                             i18n.url,
                    '        <br/><small class="form-help">', i18n.urlInfo, '</small>',
                    '    </label>',
                    ...
                    '        <br/><small class="form-help">', i18n.emptyPixInfo, '</small>',
                    '    </label>',
                    '</div>',
                    '<div class="form-group">',
                    '    <label for="name">',
                             i18n.name,
                    '        <br/><small class="form-help">', i18n.nameInfo, '</small>',
                    '    </label>',
                    ...
                    '    </select>',
                    '</div>',
                    '<a class="" role="button" data-toggle="collapse" href="#collapseAdvancedSettings" aria-expanded="false" aria-controls="collapseAdvancedSettings">',
                    ...
                    '        <label for="extra">',
                                 i18n.extra,
                    '            <br/><small class="form-help">', i18n.extraInfo, '</small>',
                    '        </label>',
                    ...
                    '        <label for="expires_at">',
                                 i18n.expiresAt,
                    '            <br/><small class="form-help">', i18n.expiresAtInfo, '</small>',
                    '        </label>',
                    '        <input type="number" step="1" min="0" class="form-control" name="expires_at" id="doloExpiresAt" value="', button.data('expires_at'), '">',
                    '    </div>',
                    '    <div class="form-group">',
                    '        <label for="expires_after">',
                                 i18n.expiresAfter,
                    '            <br/><small class="form-help">', i18n.expiresAfterInfo, '</small>',
                    '        </label>',
                    '        <input type="number" step="1" min="0" class="form-control" name="expires_after" id="doloExpiresAfter" value="', button.data('expires_after'), '">',
                    '    </div>',
                    '</div>',
                ].join('')
            );
        ...
        case 'dolo':
            ...
            modal.find('.modal-body form').html(
                [
                    ...
                    '    <label for="short"">',
                             i18n.doloUrl,
                    '        <br/><small class="form-help">', i18n.doloUrlInfo, '</small>',
                    '    </label>',
                    ...
                    '    </div>',
                    '    <div class="form-group">',
                    '        <label for="expires_at">', i18n.expiresAt,
                    '            <br/><small class="form-help">', i18n.expiresAtInfo, '</small>',
                    '        </label>',
                    '        <input type="number" step="1" min="0" class="form-control" name="expires_at" id="doloExpiresAt" value="', button.data('expires_at'), '">',
                    '    </div>',
