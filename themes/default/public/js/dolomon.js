        ...
        case 'dolo':
            ...
            modal.find('.modal-body form').html(
                [
                    ...
                    '        <span data-toggle="tooltip" data-placement="bottom" title="', i18n.emptyPixInfo, '">',
                    '            <span class="glyphicon glyphicon-question-sign" aria-hidden="true"></span><span class="sr-only">', i18n.help, '</span>',
                    '        </span>',
                    '    </label>',
                    '</div>',
                    ...
                    '    <span data-toggle="tooltip" data-placement="bottom" title="', i18n.nameInfo, '">',
                    '        <span class="glyphicon glyphicon-question-sign" aria-hidden="true"></span><span class="sr-only">', i18n.help, '</span>',
                    '    </span>',
                    ...
                    '        <span data-toggle="tooltip" data-placement="bottom" title="', i18n.extraInfo, '">',
                    '            <span class="glyphicon glyphicon-question-sign" aria-hidden="true"></span><span class="sr-only">', i18n.help, '</span>',
                    '        </span>',
                    ...
                    '        <span data-toggle="tooltip" data-placement="bottom" title="', i18n.expiresAtInfo, '">',
                    '            <span class="glyphicon glyphicon-question-sign" aria-hidden="true"></span><span class="sr-only">', i18n.help, '</span>',
                    '        </span>',
                    ...
                    '        <span data-toggle="tooltip" data-placement="bottom" title="', i18n.expiresAfterInfo, '">',
                    '            <span class="glyphicon glyphicon-question-sign" aria-hidden="true"></span><span class="sr-only">', i18n.help, '</span>',
                    '        </span>',
        ...
        case 'dolo':
            ...
            modal.find('.modal-body form').html(
                [
                    ...
                    '    <span data-toggle="tooltip" data-placement="bottom" title="', i18n.doloUrlInfo, '">',
                    '        <span class="glyphicon glyphicon-question-sign" aria-hidden="true"></span><span class="sr-only">', i18n.help, '</span>',
                    '    </span>',
                    ...
                    '    <div class="form-group">',
                    '        <label for="expires_after">', i18n.expiresAfter,'</label>',
                    '        <span data-toggle="tooltip" data-placement="bottom" title="', i18n.expiresAfter, '">',
                    '            <span class="glyphicon glyphicon-question-sign" aria-hidden="true"></span><span class="sr-only">', i18n.help, '</span>',
                    '        </span>',
                    '        <input type="number" step="1" min="1" class="form-control" name="expires_after" id="doloExpiresAfter" value="', button.data('expires_after'), '">',
                    '    </div>',
